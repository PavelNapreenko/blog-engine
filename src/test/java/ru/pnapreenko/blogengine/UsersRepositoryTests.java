...
public class UsersRepositoryTests {
    ...
    public void init() {
        ...
        user.setName("Joahn IV");
        user.setEmail("joahn.IV@email.tld");
        user.setPassword("grozniy");
    }
    ...
    public void testCantAddAnotherUserWithSameEmail() {
        ...
        anotherUser.setName("Joahn III");
        anotherUser.setEmail("joahn.III@email.tld");
        anotherUser.setPassword("negrozniy");
